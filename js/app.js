 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        const enableSwipers = function() {
            if (document.querySelector(".about-team__slider")) initSlider(".about-team__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                spaceBetween: 15,
            ...
            if (document.querySelector(".featured__slider")) initSlider(".featured__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                spaceBetween: 10,
        ...
        if (heroVideo) playPauseButton.addEventListener("click", (function() {
            if (heroVideo.paused) {
                heroVideo.play();
            ...
            if (referralLinkField) {
                ...
                function copyReferralLink() {
                    try {
                        ...
                        })); else if (navigator.clipboard && navigator.clipboard.writeText) navigator.clipboard.writeText(referralLinkField.value).then((() => {
